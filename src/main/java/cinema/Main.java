...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User firstUser;
        try {
            firstUser = authenticationService.register("firstUser@gmail.com", "firstUserPassword");
        ...
        System.out.println(orderService.completeOrder(shoppingCartService.getByUser(firstUser)));
